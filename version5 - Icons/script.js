...
function drawWeather( data ) {
	...
	// document.getElementById('main-description').innerHTML = weatherIcon(main_description);
	...
	document.getElementById('date').innerHTML = '<b>Today</b> ' + fullDate[2] + '<sup>th</sup> ' + fullDate[1];					// Date
